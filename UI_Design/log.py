...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logTable = QtWidgets.QTableWidget(self.widget)
        self.logTable.setGeometry(QtCore.QRect(-30, 0, 621, 441))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.defect_chart_labe.setText(_translate("MainWindow", "Log Report"))
        item = self.logTable.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Name "))
        item = self.logTable.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Type of glove"))
        item = self.logTable.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Type of defect"))
