...
# Form implementation generated from reading ui file 'simulation_screen.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gloveImage = QtWidgets.QLabel(self.chart)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gloveImage.sizePolicy().hasHeightForWidth())
        self.gloveImage.setSizePolicy(sizePolicy)
        self.gloveImage.setText("")
        self.gloveImage.setObjectName("gloveImage")
        self.gridLayout.addWidget(self.gloveImage, 1, 0, 1, 1)
        self.startButton = QtWidgets.QPushButton(self.chart)
        self.startButton.setObjectName("startButton")
        self.gridLayout.addWidget(self.startButton, 6, 0, 1, 1)
        self.progressBar = QtWidgets.QProgressBar(self.chart)
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.gridLayout.addWidget(self.progressBar, 2, 0, 1, 1)
        self.totalDefectLabel = QtWidgets.QLabel(self.chart)
        self.totalDefectLabel.setObjectName("totalDefectLabel")
        self.gridLayout.addWidget(self.totalDefectLabel, 4, 0, 1, 1)
        self.totalGloveLabel = QtWidgets.QLabel(self.chart)
        self.totalGloveLabel.setObjectName("totalGloveLabel")
        self.gridLayout.addWidget(self.totalGloveLabel, 3, 0, 1, 1)
        self.stopButton = QtWidgets.QPushButton(self.chart)
        self.stopButton.setObjectName("stopButton")
        self.gridLayout.addWidget(self.stopButton, 7, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.totalDefectLabel.setText(_translate("MainWindow", "Total Defects found: "))
