...
image = cv2.imread(
    "C:\\Users\\user\\Desktop\\University\\Degree\\Year 3\\Sem 1\\Image Processing Computer Vision and Pattern Recognition\\Glove-Defect-Detection-System\\Images\\Latex\\Dirt_2.jpg"
)
...
contours, _ = cv2.findContours(
    inverted_threshold, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE
)
